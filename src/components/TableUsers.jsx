...
const TableUsers = ({ usersData }) => {
  ...
  const handleDisableUser = async (userId) => {
    try {
      const res = await axios.patch(`http://localhost:3000/sj/api/users/disabled/${userId}`)
  ...
  return (
    <div className="font-sans">
      ...
      {showAlert && <AlertUser title= {titleAlert} setAlertTitle={setTitleAlert} setShowAlert={setShowAlert}/> }
      </div>
      <div className="">
        <div className="">
          <div className="flex justify-between items-center -mt-5 sm:-mt-1">
            <div className="flex flex-row items-center">
              <div className="flex flex-row items-center">
                ...
                <div className="relative">
                  <select
                    className="h-9 rounded-r text-xs sm:text-sm border-t sm:rounded-r-none sm:border-r-0 border-r border-b block appearance-none w-auto bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:border-l focus:border-r focus:bg-white focus:border-gray-500"
            ...
            <div className="-ml-52">
              <button className="bg-gradient-to-b mb-2 w-max mx-auto text-gray-600 text-xs sm:text-sm text-center font-bold from-gray-200 to-gray-200 px-1 py-1 rounded-sm shadow-gray-500 shadow-md border-b-4 hover border-gray-400 hover:shadow-sm transition-all duration-500">
                Agregar Usuario
              </button>
            </div>
          </div>
