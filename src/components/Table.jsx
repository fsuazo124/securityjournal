            ...
            <div className="my-2 flex sm:flex-row flex-col">
                <div className="flex flex-row mb-1 sm:mb-0">
                    <div className="relative">
                        <select
                            className="h-9 rounded-l border text-base block appearance-none w-15 bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            <option>5</option>
                            <option>10</option>
                            <option>20</option>
                        </select>
                    ...
                    <div className="relative">
                        <select
                            className="h-9 rounded-r text-base border-t sm:rounded-r-none sm:border-r-0 border-r border-b block appearance-none w-30 bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:border-l focus:border-r focus:bg-white focus:border-gray-500">
                            <option>Todos</option>
                    ...
                    <table className="min-w-full leading-normal">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <LiaUserEditSolid className="h-6 w-6 hover:h-10 hover:"/>
                                </td>
                            </tr>
                            <tr>
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
